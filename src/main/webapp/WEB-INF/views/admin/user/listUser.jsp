										...
										<div class="panel">
											<div class="panel-heading">
												...
												<div class="right">
													...
													<a href="<c:url value="/admin/user-create"/>"><span
													...
													<tbody>
														<c:forEach items="${users}" var="user" varStatus="loop">
															<tr>
																...
																<td style="vertical-align: middle;"><img src="https://bucketslhs.s3.amazonaws.com/${user.avatar}"
																	alt="Avatar" class="avatar img-circle"
																	style="width: 100%;width: 26px;height:26px; margin-top: -4px;"></td>
																<td style="vertical-align: middle; padding-left: 25px;">${user.email}</td>
																<td style="vertical-align: middle; width: auto">${user.fullname}</td>
																...
																<td style="vertical-align: middle;"><a href="<c:url value="/admin/user-update?userId=${user.userId}"/>">
