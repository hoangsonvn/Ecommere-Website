                                        ...
                                        <div class="panel-body no-padding">
                                            <table class="table table-striped" style="margin: auto;">
                                                ...
                                                <c:forEach items="${orders}" var="order" varStatus="loop">
                                                    <tr>
                                                        <td style="vertical-align: middle;"><input class="checkbox" type="checkbox" name="orderId"
                                                                                                   value="${order.orderId}" id="${loop.count}" style="cursor: pointer;"/></td>
                                                        ...
                                                        <c:if test="${order.status eq 'PENDING'}">
                                                            <td>
                                                                <a href="<c:url value="/admin/order-update?orderId=${order.orderId}&pageIndex=${pageIndex}"/>">
                                                    ...
                                                    <li class="page-item"><a class="page-link"
                                                            <c:if test="${i == pageIndex}">
                                                                style="background-color: #F0AD4E; color: white;"
                                                                             ...
                                                                             href="<c:url value="/admin/order-list?pageIndex=${i}"/>">${i + 1}</a>
                                                    </li>
                                                </c:forEach>
                                            </ul>
                                        </nav>
