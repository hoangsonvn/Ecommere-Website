    ...
    <div class="auth-form" style="background-color: white;">
        <div class="auth-form-container">
            <a href="client/home"><h5 class="auth-form-title"
                                      style="text-align: center; padding-top: 20px;">PiFood
            </h5></a>
                ...
                <div class="auth-form-group">
                    ...
                    <c:if test="${verifySuccess != null}">
                        <div style="display: flex; margin-bottom: 2px; color: #339900;">
                            ...
                            <a class="btn btn-success" href="<c:url value="/login"/>" style="margin-left: 10px;background: #00aa00">Login</a>
                        </div>
                    </c:if>
            ...
            <div style="font-size: 17px; text-align: center;">
					<span>Did'nt work? <a style="text-decoration: none;color: #770088" href="resend-code">Send me another code.</a>
					</span>
            </div>
