...
<form action="<c:url value="/newpasswordget"/>" method="post">
    <div class="auth-form" style="background-color: white; width: 400px; height: 300px;">
        <div class="auth-form-container">
            <div class="auth-form-header">
                <h3 style="color: #ea4c89;" class="auth-form-title">Authentication</h3>
            ...
            <div class="auth-form-controls" style="margin-bottom: 10px;">
