...
import static com.mysql.cj.conf.PropertyKey.yearIsDateType;
...
public class OrderDaoImpl implements OrderDao {
    ...
    public void deleteOrderClientById(Long id) {
        String sql = "update Order o set o.deleted=true where o.orderId= :id";
        sessionFactory.getCurrentSession().createQuery(sql)
                .setParameter("id",id).executeUpdate();
    }

    @Override
    public List<Order> findAllOrderCLientById(Long id) {
        String sql = "SELECT o from Order o where o.buyer.userId= :id and o.deleted = false order by o.orderId desc";
        TypedQuery<Order> typedQuery = sessionFactory.getCurrentSession().createQuery(sql,Order.class)
                .setParameter("id",id);
    ...
    public void delete(long orderId) {
        try {
            ...
            String sql = "DELETE FROM order_user WHERE order_user.order_id= :orderId";
