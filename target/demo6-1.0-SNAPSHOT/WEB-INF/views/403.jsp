...
<div class="error">
    <div class="error__title">Denied</div>
    <div class="error__subtitle">Hmmm...</div>
    <div class="error__description">You don't have permission to access ~</div>
    <br>
    <sec:authorize access="hasAnyRole('ADMIN','STAFF','EDITOR')">
        <a href="<c:url value="/admin/home"/> " class="error__button error__button--active"> Back Home</a>
    </sec:authorize>
    <sec:authorize access="hasRole('USER')">
        <a href="<c:url value="/client/home"/> " class="error__button error__button--active">Back Home</a>
    </sec:authorize>
    <a href="https://www.facebook.com/Pi-Halo-103258795742214/" class="error__button">Contact</a>
</div>
