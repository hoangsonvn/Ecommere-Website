					...
					<div class="panel panel-headline">
						...
						<div class="panel-body no-padding">
							<table class="shop-table" style="padding: 30px;">
										...
										<tr>
											<td><a
												href="<c:url value="/client/product-details?productId=${item.productDTO.productId}"/>"><img
													src="https://bucketslhs.s3.amazonaws.com/${item.productDTO.image}" alt=""></a></td>
											<td>
											...
											<td>
												<h5 style="color: #41B314; font-weight: bold;">$${Math.round(item.productDTO.price-item.productDTO.saleDTO.salePercent*item.productDTO.price/100)}.00</h5>
											...
											<td><select style="color: darkcyan;">
														<option style="color: #ee3423;" value="${item.vote}">${item.vote}
															Star</option>
											</select></td>
										</tr>
									</c:forEach>
								...
								<tfoot>
									<tr>
										<td colspan="6"><span class="pull-left">Sub Total: <span style="color: red;">$${Math.round(order.priceTotal - 5)}.00</span></span><br /> <span
											class="pull-left">Fee: <span style="color: red;">$5.00</span></span><br /> <span  
											class="pull-left" style="font-size: 22px;">Grand
												Total: <span style="color: red;">$${Math.round(order.priceTotal)}.00</span>
										</span>
