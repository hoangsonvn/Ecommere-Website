...
public class CurrentDateExcelExpoter {
    ...
    private void writeHeaderLine() {
        ...
        createCell(row, 0, "Ten san pham", style);
        createCell(row, 1, "So luong ban ra", style);
        createCell(row, 2, "So luong con lai", style);
        createCell(row, 3, "Gia san pham", style);
        createCell(row, 4, "ExpirationDate", style);
        createCell(row, 5, "Tong gia trong ngay", style);
