...
public class PermissionDaoImpl implements PermissionDao {
    ...
    public List<Permission> findByRoleId(Long roleId) {
        String nativeSql="select p.id,p.permissionKey,p.permissionName,p.description from permission p join role_permission rp on rp.permission_id=p.id where role_id= :roleId";
