        ...
        <div class="main-content">
            <div class="container-fluid">
                ...
                <div class="panel panel-headline">
                    ...
                    <form action="<c:url value="/admin/createsale"/>" method="post">
                            ...
                            <table style="margin: auto; margin-left: 60px;" class="col-md-6">
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" min="0" max="100" class="form-control"
                                               ...
                                               placeholder="Enter sale percent..." name="salePercent"/></td>
                                </tr>
                                <tr>
                                    <th>title :</th>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control"
                                               required="required" style="height: 30px;"
                                               placeholder="Enter short description ..." name="shortDescription"/></td>
                                </tr>
                                <tr>
