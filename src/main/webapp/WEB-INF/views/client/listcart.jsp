                        ...
                        <div class="col-md-12">
                            ...
                            <table class="shop-table">
                                ...
                                <tr>
                                    ...
                                    <th style="color: #761c19;font-weight: bold;">Delete</th>
                                </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="shop-details">
                                                ...
                                                <p>Sale : <strong class="pcode">-${item.value.productDTO.saleDTO.salePercent}%</strong></p>
                                                <p>Category : <strong class="pcode">${item.value.productDTO.categoryDTO.categoryName}</strong></p>
                                            </div>
                                        </td>
                                        <td>
                                            ...
                                            <form action="<c:url value="/client/editcart"/>" method="post">
                                                <select name="quantity" onchange="this.form.submit()">
                                                    <c:forEach begin="1" end="15" var="i">
                                                        <option
                                                                <c:if test="${item.value.quantity == i}">
                                                                    selected="selected"
                                                                </c:if> value="${i}">${i}
                                                        </option>
                                                    </c:forEach>
                                                    <input type="hidden" value="${item.value.productDTO.productId}"
                                                           name="productId"/>
                                                </select>
                                            </form>
                                        </td>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="shippingbox">
                                        ...
                                        <div class="grandtotal">
                                            <p style="color: #151515;font-size: 19px; font-weight: bold;">
                                                Temporary Price</p>
                                            <span style="margin-bottom: 20px;">$${Math.round(TotalPriceCartSale+5)}.00</span>
                                        </div>
                                        <a href="<c:url value="/client/confirm"/>">
