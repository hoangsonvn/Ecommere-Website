        ...
        <div class="main-content">
            <div class="container-fluid">
                ...
                <div class="panel panel-headline">
                    ...
                    <form action="<c:url value="/admin/createvoucher"/>" method="post">
                        ...
                        <div class="row"
                            ...
                            <table style="margin: auto; margin-left: 60px;" class="col-md-6">
                                <tr>
                                    ...
                                    <td><input type="number" min="0" max="99"  class="form-control"
                                           ...
                                           placeholder="..."     name="voucherPercent"/></td>
                                </tr>
                                <tr>
                                    <th>Code: </th>
                            ...
                            <table
                                ...
                                <tr>
                                    ...
                                    <td><input required="required" type="date" id="effectiveDate" name="effectiveDate">
                                    </td>
                                </tr>
                                <tr>
