									 ...
									 <sec:authorize access="isAuthenticated()">
										<ul class="usermenu" style="display: flex;">
											<li> <a href="<c:url value="/client/profile"/>"><img class="img-circle"
												...
												<a href="<c:url value="/client/profile"/>" style="margin-left: -22px;"><span style="margin-left: 5px; color: white; font-size: 14px;"><%=SecurityUtils.getPrincipal().getFullname()%></span>
												</a>
											</li>
											<li><i
						...
						<ul class="option">
							<li id="search" class="search">
								<form action="<c:url value="/client/search"/>"  method="get">
									<div style="float: right;clear: left;">									<input class="search-submit" type="submit" value="">
									</div>
