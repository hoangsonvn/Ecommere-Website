            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-headline">
                    <div class="panel-heading"
                        ...
                        <a class="btn btn-warning" href="<c:url value="/admin/user-list"/>"
                           style="background-color: #D9534F; padding: 2px 10px; text-decoration: none; border: none; margin-right: 10px; height: 25px;">Back</a>
                    </div>
                    <form action="<c:url value="/admin/user-create"/>" method="post" enctype="multipart/form-data">
                                                <div class="row"
                             style="display: flex; justify-content: space-between;">
                            <table
                                ...
                                <tr>
                                    ...
                                    <td><input type="radio" checked="checked" name="gender"
                                        ...
                                        <input type="radio" name="gender" value="false" style="cursor: pointer;"/>
                                        Female
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input required="required" type="tel"
                                               class="form-control" style="height: 30px;"
                                               pattern="[0-9]{10}" required placeholder="10 digits..." name="phone"/></td>
                                </tr>
                                <tr>
                                    <th>Address:</th>
                            ...
                            <table style="margin: auto; margin-right: 30px;"
                                ...
                                <tr>
                                    <th>Password:</th>
                                    <td><input required="required" type="password" min="6"
max="20"                                               class="form-control" style="height: 30px;"
